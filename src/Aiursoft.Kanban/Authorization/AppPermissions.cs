namespace Aiursoft.Kanban.Authorization;
...
public class AppPermissions
{
    ...
    public static List<PermissionDescriptor> GetAllPermissions()
    {
        ...
        [
            ...
            new(AppPermissionNames.CanViewAnyUserTasks,
                localizer["View Any User Tasks"],
                localizer["Allows viewing the task list of any user in the system."]),
            ...
            new(AppPermissionNames.CanManageAnyBoardShare,
                localizer["Manage Any Board Share"],
